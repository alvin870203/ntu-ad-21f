...
filename = './tmp_curve_closest.jpg'
...
class Lane:
    ...
    def __init__(self, orig_frame):
        ...
        self.roi_points = np.float32([
            (841,577),#(498, 726),  # Top-left corner
            (100, 901),  # Bottom-left corner
            (1407, 901),  # Bottom-right corner
            (1053,577)#(1199, 726)  # Top-right corner
        ])
        ...
        self.YM_PER_PIX = 1080 / 1080  # meters per pixel in y dimension
    ...
    def calculate_car_position(self, print_to_terminal=False):
        ...
        ##print((bottom_right - bottom_left)/2)
    ...
    def display_curvature_offset(self, frame=None, plot=False):
        ...
        cv2.putText(image_copy, 'Curve Radius: '+str((
            ...
            self.left_curvem+self.left_curvem)/2)[:7]+' m', (int((
    ...
    def get_lane_line_indices_sliding_windows(self, plot=False):
        ...
        leftx_base = self.histogram_peak()
    ...
    def my_get_line_markings(self, frame=None):
        ...
        ##self.lane_line_markings = cv2.bitwise_or(mask_yello, mask_white)
    ...
    def histogram_peak(self):
        ...
        ##roi_bottom_right_x = int(self.desired_roi_points[2][0])
        leftx_base = np.argmax(self.histogram[roi_bottom_left_x:midpoint]) + roi_bottom_left_x  # bottom-left-x to mid
        ##rightx_base = np.argmax(self.histogram[midpoint:roi_bottom_right_x]) + midpoint  # mid to bottom-right-x      
...
def main():
    ...
    # Display the image
    cv2.imshow("Image", frame_with_lane_lines2)

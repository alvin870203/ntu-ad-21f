...
EGO_POS = (78.74, 0.0, -11.37)
EGO_ROT_Y = 70

END_POS = (53.64, 0.0, 61.24)

NPC1_POS = (84.39, 0.0, 35.02)
NPC1_ROT_Y = 340

NPC2_POS = (74.49, 0.0, 57.75)
NPC2_ROT_Y = 310
...
def main():
    ...
    state = lgsvl.AgentState()
    # waypoints = load_waypoints("npc1.csv", 4.0)
    state.transform.position = lgsvl.Vector(*NPC1_POS)
    state.transform.rotation.y = NPC1_ROT_Y
    ...
    state.transform.position = lgsvl.Vector(*NPC2_POS)
    state.transform.rotation.y = NPC2_ROT_Y

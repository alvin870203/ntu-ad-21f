...
EGO_POS = (-68.59, 0.0, 2.85)
# EGO_POS = (-63.93, 0.0, -10.10)
EGO_ROT_Y = 160

END_POS = (-42.16, 0.0, -4.90)
...
def main():
    ...
    waypoints = load_waypoints("npc.csv", speed)
    ...
    while not failed:
        ...
        # set_movement(npc1.state, NPC1_VEL, NPC1_ROT_Y + 90.0 * step)
        step += 1
